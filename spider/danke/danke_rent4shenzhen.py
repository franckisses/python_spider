...
async def request(_):
    url = 'https://www.dankegongyu.com/room/sz?page={}'.format(_)
    # 返回请求的响应
    ...
    for x in range(20):
        ...
        with open("danke.json","a",encoding="utf-8") as  f:
            f.write(json.dumps(item,ensure_ascii=False)+"\n")

def main():
    tasks = [asyncio.ensure_future(request(_)) for _ in range(1,149)]
